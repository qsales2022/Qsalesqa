...
const ProductDetails = ({route, navigation}: any) => {
  ...
  useEffect(() => {
    ...
    const ModelList = filterUniqueItem(variantList, 'Model');
    const desingList = filterUniqueItem(variantList, 'Design');
    const capacityList = filterUniqueItem(variantList, 'Capacity');
    const styleList = filterUniqueItem(variantList, 'Style');
    ...
    setModelToShow(
      productHasVariantSize(variantList, 'Model') ? ModelList : variantList,
    );
    setDesignToShow(
      productHasVariantSize(variantList, 'Design') ? desingList : variantList,
    );
    setCapacityToShow(
    ...
    setStyleToShow(
      productHasVariantSize(variantList, 'Style') ? styleList : variantList,
    );
  }, [variantList]);
