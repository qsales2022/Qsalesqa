  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ padding: 16 }}>
        <Text style={{ color: Colors.black,fontWeight:'500',fontSize:16 }}>{t('chatWithUs')}</Text>
        <View style={{ flexDirection: "row",backgroundColor:'#DEF4DC',padding:16,borderRadius:10,marginTop:6 }}>
          <Image
            style={{ height: 24, width: 24 }}
            source={images.whatsapp}
          ></Image>
          <Text style={{flex:1,marginLeft:6,color:Colors.black}}>{t('chatWithUseSub')}</Text>
        </View>
        <TouchableOpacity onPress={()=> {
           Linking.openURL('https://api.whatsapp.com/send?phone=97470119277&text=Hi,%20I%20need%20help...')
           .then((data) => {
        ...
        //  navigation.navigate(screens.webView,{url:'https://api.whatsapp.com/send?phone=97470119277&text=Hi,%20I%20need%20help...',title:`${t('fathimaSana')}`})
          }} style={{flexDirection:'row',marginTop:16,padding:16,backgroundColor:'white',borderRadius:10}}>
        <Image
            style={{ height: 25, width: 25,alignSelf:'center' }}
            source={images.helpFemale}
          ></Image>
          <View style={{marginLeft:6,alignSelf:'center'}}>
            <Text style={{color:Colors.black,fontWeight:'500'}}>{t('fathimaSana')}</Text>
            <Text style={{fontSize:12,color:'grey'}}>{t('designationHelp')}</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity onPress={()=> {
           Linking.openURL('https://api.whatsapp.com/send?phone=97470119277&text=Hi,%20I%20need%20help...')
          ...
          }} style={{flexDirection:'row',marginTop:6,padding:16,backgroundColor:'white',borderRadius:10}}>
        <Image
            style={{ height: 25, width: 25,alignSelf:'center' }}
            source={images.helpMale}
          ></Image>
          <View style={{marginLeft:6,alignSelf:'center'}}>
            <Text style={{color:Colors.black,fontWeight:'500'}}>{t('muhammedIrfan')}</Text>
            <Text style={{fontSize:12,color:'grey'}}>{t('designationHelp')}</Text>
          </View>
        </TouchableOpacity>
