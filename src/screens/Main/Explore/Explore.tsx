...
const Explore = () => {
  ...
  console.log(kitchenSuppliesList, "this is decorSSSSSSSS");
  return (
    <>
      ...
      >
       ...
       <ExploreItems
        ...
        :
        <>
        <SkeletonCard  data={[1,2,34,4]} childViewHeight={10}  chaildVieWidth={4} containerMarginTop={15} ContainerHeight={6}/>
        <SkeletonCard  data={[1,2,34,4]} childViewHeight={10}  chaildVieWidth={4} containerMarginTop={15} ContainerHeight={6}/>        
        <SkeletonCard  data={[1,2,34,4]} childViewHeight={10}  chaildVieWidth={4} containerMarginTop={15} ContainerHeight={6}/> 
        <SkeletonCard  data={[1,2,34,4]} childViewHeight={10}  chaildVieWidth={4} containerMarginTop={15} ContainerHeight={6}/> 
